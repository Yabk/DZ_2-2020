...
# jedinstveni_korisnici.dat. Racunajte da su imena u datoteci case insensitive. (1.0)



#!#!#!#!#!#!#
# 6. Ispisite sva nejedinstvena korisnicka imena iz datoteke korisnici.dat u datoteku
# nejedinstveni_korisnici.dat. Racunajte da su imena u datoteci case insensitive. (1.0)
...
#!#!#!#!#!#!#
# 10. Locirajte datoteku jedinstveni_korisnici.dat koristeci naredbu find. (0.5)



#!#!#!#!#!#!#
# 11. Locirajte datoteku jedinstveni_korisnici.dat koristeci naredbu locate.
# U ovom zadatku je dozvoljeno rjesenje s vise linija. (0.5)
...
# modification time) bilo u 10. mjesecu. (0.75)
